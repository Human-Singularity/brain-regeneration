...
**CRITICAL**: Always install Hugo **Extended** edition (not Standard).
...
**Required**:
- Hugo v0.155.0+ (Extended edition) - Static site generator
...
**Hugo**: v0.155.3+extended (October 24, 2025)
...
- [ ] Hugo Extended v0.155.0+ installed (`hugo version` shows "+extended")
